  ...
  return (
    <div className="admin-navbar">
      <ul>
        ...
        <li className={location.pathname === '/admin/business-intelligence' ? 'active' : ''}>
        <a href="http://138.197.110.88/" target="_blank" rel="noopener noreferrer">Inteligencia de Negocio</a>
        </li>
